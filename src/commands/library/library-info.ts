...
export class LibraryInfoCommand extends CommandRegistrar {
    protected async execute(...args: any[]): Promise<void> {
        ...
        if (githubLink !== undefined)
            TerminalInterface.libraryInfo(this.addPrefix(githubLink));
    }

    constructor(context: vscode.ExtensionContext,register: boolean) {
        super(context, register, 'premake5.library-info', "get library info");
    }
